          ...
          <div className={`${footerClassName}-container`}>
            <div className={`${footerClassName}-first`}>
              ...
              <div className={`${footerClassName}-icons`}>
                {[
                  data.icons.map((item, index: number) => {
                    return (
                      <a
                        href={item.link}
                        target="_blank"
            ...
            <div className={`${footerClassName}-second`}>
              {data.data.map((item, index) => {
                return (
                  <div className={`${footerClassName}-item`} key={`${footerClassName}-item_${index}`}>
          ...
          <div className={`${footerClassName}-end-grid`}>
            <div className={`${footerClassName}-end-flexColumn`}>
              ...
              <div className={`${footerClassName}-end-flex`}>
                {data.end.info.map((item: any, index: number) => {
                  return (
                    <div className={`${footerClassName}-end-text`} key={`${footerClassName}-end-text_${index}`}>
                      {item.text}
                    </div>
                  );
                })}
